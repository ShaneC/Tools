...
/**
 * \brief Thrown when an API call returns an exception.
 *
...
/**
 * \brief Provides access to the Facebook Platform.
 *
 * @author Naitik Shah <naitik@facebook.com>
 */
class Facebook
{
  ...
  /**
   * Get a string of user permissions
   * @author Shane Chism <schism@acm.org>
   * @return string to be used in a permissions context
   */
   public function getPermsStr( $mode ){
		global $sys;
		$str = NULL;
		if( $mode == 'user' ){
			foreach( $sys['fb']['userpermissions'] as $value )
				$str .= ( $value == "email" ) ? "email," : "user_" . $value . ",";
