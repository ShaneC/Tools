...
define( "PS", "C:\Users\Shane Chism\Documents\!Dev\Websites\SGAConcierge\src" );
//define( "PS", realpath( '.' ) );
...
# Load Hook Control
$_SAction = new SAction();

# Determine URL REWRITE status
define( "REWRITE_ON", true );

session_start();

$_SAction->fire( "EVT_SYS_INITIALIZED" );
