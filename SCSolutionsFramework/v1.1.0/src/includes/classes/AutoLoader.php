...
/** Set the correct database class for autoloading **/
switch( $sys['db']['type'] ){
	case 'mssql'	:	$sysAutoLoadClasses['Database'] = "MSSQLDatabase.php"; break;
	default			:	$sysAutoLoadClasses['Database'] = "MySQLDatabase.php"; break;
}
